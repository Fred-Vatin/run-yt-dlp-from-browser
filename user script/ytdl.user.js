  ...
  function createButton(del = false) {
    ...
    function createYtdlButton() {
      ...
      menuEntries.forEach(entry => {
        ...
        iconWrap.innerHTML = `<svg viewBox="0 0 24 24" style="width:24px; height:24px; fill:currentColor;"><path d="${downloadIconPath}"></path></svg>`;
      ...
      buttonContainer.appendChild(menuPopup);
